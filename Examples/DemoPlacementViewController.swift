...
//        let diffLon = -122.86824490727534 + 122.99017089272466
...
//                                      minLon: -122.99017089272466, maxLon: -122.86824490727534)
    ...
    private func defaultMaterials() -> [SCNMaterial] {
        ...
        groundImage.diffuse.contents = UIColor.darkGray.withAlphaComponent(0.5)
        groundImage.name = "Ground texture"

        let sideMaterial = SCNMaterial()
        sideMaterial.diffuse.contents = UIColor.darkGray.withAlphaComponent(0.5)
        ...
        bottomMaterial.diffuse.contents = UIColor.black.withAlphaComponent(0.5)
    ...
    private func addUserPath(to terrainNode: TerrainNode) {
        ...
        var positionArray: [SCNVector3] = [SCNVector3]()
...
//        locationPath.close()
        ...
        subsampledPoints.append(positionArray.last!)

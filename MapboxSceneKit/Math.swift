...
internal class Math {
    ...
    static func centerCoordinate(southWestCorner: CLLocation, northEastCorner: CLLocation) -> CLLocation{
        
        let _loc1: CLLocationCoordinate2D = southWestCorner.coordinate
        let _loc2: CLLocationCoordinate2D = northEastCorner.coordinate
        
        let lon1 = _loc1.longitude * .pi / 180;
        let lon2 = _loc2.longitude * .pi / 180;
        
        let lat1 = _loc1.latitude * .pi / 180;
        ...
        let latitude  = lat3 * 180 / .pi;
        let longitude = lon3 * 180 / .pi;
